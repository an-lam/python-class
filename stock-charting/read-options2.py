...
def plot_charts2(put_options, call_options):
    ...
    for i in range(0, 11):
        ...
        exp_strike = str(put_options[i][7])[:6] + " " + str(put_options[i][8])
        ...
        exp_strike = str(call_options[i][7])[:6] + " " + str(call_options[i][8])
